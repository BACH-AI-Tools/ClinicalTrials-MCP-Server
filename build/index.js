...
class ClinicalTrialsServer {
    ...
    async handleGetSimilarStudies(args) {
        ...
        try {
            ...
            if (!referenceResponse.data.studies ||
            ...
            switch (similarityType) {
                case "CONDITION":
                    ...
                    break;
                case "SPONSOR":
                    const sponsor = referenceStudy.protocolSection.sponsorCollaboratorsModule
                        ?.leadSponsor?.name;
                    if (sponsor) {
                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            referenceStudy: {
                                nctId: args.nctId,
                                title: referenceStudy.protocolSection.identificationModule
                                    .briefTitle,
                            },
                            similarityType,
                            totalCount: response.data.totalCount || 0,
